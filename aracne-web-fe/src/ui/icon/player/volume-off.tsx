export const VolumeOff = (props: any) => {
    return (
        <svg viewBox="0 0 31.00 31.00" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <g id="SVGRepo_iconCarrier"><title>volume-muted</title>
                <desc>Created with Sketch Beta.</desc>
                <defs></defs>
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" sketch:type="MSPage">
                    <g id="Icon-Set-Filled" sketch:type="MSLayerGroup" transform="translate(-311.000000, -571.000000)"
                       fill="none" {...props}>
                        <path
                            ...
                            id="volume-muted" sketch:type="MSShapeGroup"></path>
                    </g>
                </g>
            </g>
        </svg>
